...
Il testo è pensato per essere letto senza conoscenze di statistica. Chi volesse il dettaglio dei metodi, delle verifiche e del codice lo trova nel [README](README.it.md), che accompagna passo per passo tutte le dieci fasi del lavoro.
...
Restano infine alcune assunzioni tecniche del modello che i dati violano. Sono dichiarate apertamente nel [README](README.it.md), insieme alle contromisure adottate e alla verifica — condotta esplicitamente — che le conclusioni non cambiano.
...
Ogni decisione presa durante la pulizia è documentata con il conteggio delle righe prima e dopo, comprese le operazioni che si sono rivelate inutili una volta eseguite. Il dettaglio completo, insieme alla discussione dei metodi statistici impiegati in ciascuna fase, si trova nel [README](README.it.md).
